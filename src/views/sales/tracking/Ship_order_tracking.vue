            ...
            <v-tab-item id="tab-1">
              ...
              >
                <template slot="items" slot-scope="props">
                  <td>{{ props.item.ship_order.tracking }}</td>
  ...
  methods: {
    ...
    edit(id) {
      ...
      axios
        ...
        .then(response => {
          ...
          this.tracking = response.data.data.ship_order.tracking;
          this.lng = response.data.data.lng;
    ...
    save(id = null) {
      if (this.$refs.form.validate()) {
        ...
        axios
          .put("tracking/" + this.id, data)
          .then(response => {
            this.snackbar = {
              show: true,
              text: "Tracking editado con éxito",
              color: "success",
              icon: "fa fa-check"
            };
